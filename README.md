...
> Check out the [v1-popover](https://github.com/ahkohd/tauri-macos-menubar-app-example/tree/v1-popover) branch for an example of the menubar app, now featuring a popover view.
